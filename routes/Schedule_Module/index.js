...
let checkExamination = function () {
    new JWXT().checkNewExamination('0141122427', '121021','shianqi@imudges.com').then(()=>{},(error)=>{
        console.log(error);}
    );
    new JWXT().checkNewExamination('0141121972', 'PX1069848942','1069848942@qq.com').then(()=>{},(error)=>{
        console.log(error);}
    );
};
